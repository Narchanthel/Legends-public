this.legend_pauldrons_shoulderplates_heraldic <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	m = {},
	function create()
	{
		this.legend_armor_upgrade.create();
		this.m.ID = "legend_armor_upgrade.body.legend_pauldrons_shoulderplates_heraldic";
	...
	{
		/*this.m.Icon = "armor_upgrades/upgrade_14.png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "armor_upgrades/icon_upgrade_14.png";
		this.m.OverlayIconLarge = "armor_upgrades/inventory_upgrade_14.png";
		this.m.SpriteFront = "upgrade_14_front";
		this.m.SpriteBack = "upgrade_14_back";
		this.m.SpriteDamagedFront = null;
		this.m.SpriteDamagedBack = "upgrade_14_back_damaged";
		this.m.SpriteCorpseFront = "upgrade_14_front_dead";
		this.m.SpriteCorpseBack = "upgrade_14_back_dead";*/
